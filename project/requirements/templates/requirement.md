...
For more complex conditions, use the following format:

1. Given `starting condition`, and `another condition`, when `action`, then `observable result`, and `another observable result`.
