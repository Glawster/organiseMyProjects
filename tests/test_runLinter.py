...
class TestRunLinter:
        ...
        try:
            ...
            with patch("sys.argv", testArgs):
                with patch("organiseMyProjects.runLinter.lintGuiNaming") as mockLintGui:
                    ...
                    assert (
                        mockLintGui.call_count == 3
                    ), f"Expected 3 calls but got {mockLintGui.call_count}. Calls: {actualCalls}"
        ...
        try:
            ...
            with patch("sys.argv", testArgs):
                with patch("organiseMyProjects.runLinter.lintGuiNaming") as mockLintGui:
                    ...
                    assert (
                        mockLintGui.call_count == 1
                    ), f"Expected 1 call but got {mockLintGui.call_count}"
    ...
    def testMainWithMarkupTarget(self):
        ...
        mockMarkupFix.assert_called_once_with(
            targets=["README.md"], fix=False, strict=False
        )
